        ...
        <div class="card-body">
            <form action="{{ route('admin.mkl.update', $mkl->nik) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_mkl') is-invalid @enderror" id="nama_mkl" name="nama_mkl" value="{{ old('nama_mkl', $mkl->nama_mkl) }}" >
                    @error('nama_mkl')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_pt_mkl') is-invalid @enderror" id="nama_pt_mkl" name="nama_pt_mkl" value="{{ old('nama_pt_mkl', $mkl->nama_pt_mkl) }}" >
                    @error('nama_pt_mkl')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('email_kantor') is-invalid @enderror" id="email_kantor" name="email_kantor" value="{{ old('email_kantor', $mkl->email_kantor) }}" >
                    @error('email_kantor')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
