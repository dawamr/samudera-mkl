        ...
        <div class="card-body">
            <form action="{{ route('admin.mkl.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_mkl') is-invalid @enderror" id="nama_mkl" name="nama_mkl" value="{{ old('nama_mkl') }}" required>
                    @error('nama_mkl')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('nama_pt_mkl') is-invalid @enderror" id="nama_pt_mkl" name="nama_pt_mkl" value="{{ old('nama_pt_mkl') }}" required>
                    @error('nama_pt_mkl')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_telepon_pribadi') is-invalid @enderror" id="no_telepon_pribadi" name="no_telepon_pribadi" value="{{ old('no_telepon_pribadi') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('no_telepon_kantor') is-invalid @enderror" id="no_telepon_kantor" name="no_telepon_kantor" value="{{ old('no_telepon_kantor') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control @error('email_kantor') is-invalid @enderror" id="email_kantor" name="email_kantor" value="{{ old('email_kantor') }}" required>
                    @error('email_kantor')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('npwp_kantor') is-invalid @enderror" id="npwp_kantor" name="npwp_kantor" value="{{ old('npwp_kantor') }}" required>
                    @error('npwp_kantor')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <select class="form-control @error('menggunakan_mtki_payment') is-invalid @enderror" id="menggunakan_mtki_payment" name="menggunakan_mtki_payment" required>
                        <option value="1" {{ old('menggunakan_mtki_payment') == '1' ? 'selected' : '' }}>Ya</option>
                        <option value="0" {{ old('menggunakan_mtki_payment') == '0' ? 'selected' : '' }}>Tidak</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control @error('file_ktp') is-invalid @enderror" id="file_ktp" name="file_ktp" required>
                    @error('file_ktp')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="file" class="form-control @error('file_npwp') is-invalid @enderror" id="file_npwp" name="file_npwp" required>
                    @error('file_npwp')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
